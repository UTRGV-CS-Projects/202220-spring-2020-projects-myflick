				...
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					>
						...
						<TextInput
							...
							value="enter current auth user's name here"
						/>
					</View>
						...
						>
							...
							>
								{date.toLocaleDateString() +
									" Enter auth user's bday date here"}
							</Text>
						</TouchableOpacity>
						{show && (
							<DateTimePicker
					...
					>
						...
						<TextInput
							...
							value="enter auth user's pronouns here"
						/>
					</View>
					...
					>
						...
						<TextInput
							...
							value="user's current location here"
						/>
					</View>
